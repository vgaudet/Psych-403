...
# all random, frequent go (2) is most likely, followed by no-go(0) and distractor go (1) with equal chance
# 0 is no-go, 1 is distractor go, 2 is frequent go
# currently set to 3/4 trials are frequent go, 1/8 distractor go, 1/8 no go
...
for block in range(nblocks):
    ...
    for trial in range(ntrials):
        ...
        elif trials[tr_current][0] == 1: # distractor go (blue)
            tr_stim.color = 'blue'
